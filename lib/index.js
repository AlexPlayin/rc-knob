...
const reduceOnStart = (state, action, callbacks) => {
    ...
    if (state.tracking) ;
    return Object.assign(Object.assign(Object.assign(Object.assign({}, state), { isActive: true }), position2), { startPercentage: state.percentage, startValue: state.value, value, sendCallback: true });
};
const reduceOnMove = (state, action, callbacks) => {
    ...
    callbacks.onInteractiveChange(value);
    if (state.tracking) ;
    return Object.assign(Object.assign(Object.assign(Object.assign({}, state), { sendCallback: true }), position2), { value });
};
const reduceOnStop = (state, action, callbacks) => {
    ...
    callbacks.onEnd();
    return Object.assign(Object.assign({}, state), { isActive: false, value: state.value, sendCallback: true, percentage: state.percentage, startPercentage: undefined, startValue: undefined });
};
const reduceOnCancel = (state, action, callbacks) => {
    ...
    callbacks.onEnd();
    if (state.tracking) ;
    return Object.assign(Object.assign({}, state), { isActive: false, value, sendCallback: true, percentage, startPercentage: undefined, startValue: undefined });
};
const reduceOnSteps = (state, action, callbacks) => {
    ...
    return Object.assign(Object.assign({}, state), { value, sendCallback: true, percentage: getPercentageFromValue(Object.assign(Object.assign({}, state), { value })) });
};
const reduceOnSet = (state, action, callbacks) => {
    ...
    return Object.assign(Object.assign({}, state), { value: newValue, sendCallback: false, percentage: percentage });
};
...
var useUpdate = ({ min, max, multiRotation, initialValue, angleOffset = 0, angleRange = 360, size, steps, onChange, onInteractiveChange, interactiveHook, onStart, onEnd, readOnly, tracking, useMouseWheel, }) => {
    ...
    const [{ percentage, value, sendCallback }, dispatch] = React.useReducer(reducer(callbacks), {
        isActive: false,
        min,
        max,
        multiRotation,
