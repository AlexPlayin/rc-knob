...
const reduceOnStart = (state, action, callbacks) => {
    ...
    if (state.tracking) ;
    return Object.assign(Object.assign(Object.assign(Object.assign({}, state), { isActive: true }), position2), { startPercentage: state.percentage, startValue: state.value, value, callBackValue: value });
};
const reduceOnMove = (state, action, callbacks) => {
    ...
    callbacks.onInteractiveChange(value);
    if (state.tracking) ;
    return Object.assign(Object.assign(Object.assign({}, state), position2), { value, callBackValue: value });
};
